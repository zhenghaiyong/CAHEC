...
class DatabaseLoader:
	...
	# ZHY4CAHEC
	# gene
	# isolate_name isolation_year isolation_country isolation_region host
	gene = ""
	isolate_name = ""
	isolation_year = ""
	isolation_country = ""
	...
	for seq_feature in record.features:
	    if seq_feature.type == 'source':
		    ...
		    if key not in ['isolate', 'strain', 'collection_date', 'country', 'host']:
		        continue
		    if not isinstance(value, list):
			value = [value]
		    if key == 'isolate':
			isolate_name = value[0]
		    elif key == 'strain':
		 	isolate_name = value[0]
	...
	# ZHY4CAHEC
	# typeA typeB subtype subsubtype subsubsubtype
	typeA = ""
	typeB = ""
	subtype = ""
        subsubtype = ""
